...
function List(e){
    ...
    if(oper === '+') //Om du väljer + så händer följande: 
    {
        ...
        const tel2 = document.querySelector("#tel").value; //Variabel som är kopplad till id: tel 2
    ...
    const text= document.querySelector("#text").value; //Variabel som är kopplad till id: text 1
    const tel = document.querySelector("#tel").value; //Variabel som är kopplad till id: tel 2
